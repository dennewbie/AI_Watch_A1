...
Note\+: Instructions for Mac\+OS with Intel CPU
...
3) Install \href{https://kafka.apache.org/}{\texttt{ Apache Kafka}}, \href{https://www.confluent.io/}{\texttt{ Confluent}} and their own dependencies. Confluent is not mandatory, but without it, you will have to set up the Kafka environment on your own.

Useful guides\+: \href{https://www.conduktor.io/kafka/how-to-install-apache-kafka-on-mac}{\texttt{ how to install Apache Kafka on Mac}}, \href{https://docs.confluent.io/4.0.1/installation/installing_cp.html}{\texttt{ how to install Confluent}}
