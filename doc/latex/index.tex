...
\begin{DoxyCode}{0}
\DoxyCodeLine{cmake .. \&\& make -\/j \(\backslash\)`sysctl -\/n hw.logicalcpu\(\backslash\)`}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{sudo ./hello\_librealsense2.bin -\/-\/num\_gpu 1 -\/-\/num\_gpu\_start 2 -\/-\/image\_dir rs\_images/rgb -\/-\/write\_json op\_output/op -\/-\/logging\_level 255}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{sudo ./hello\_librealsense2.bin}
