...
Definition at line \mbox{\hyperlink{_real_sense_manager_8hpp_source_l00169}{169}} of file \mbox{\hyperlink{_real_sense_manager_8hpp_source}{Real\+Sense\+Manager.\+hpp}}.
...
Definition at line \mbox{\hyperlink{_real_sense_d435_manager_8cpp_source_l00040}{40}} of file \mbox{\hyperlink{_real_sense_d435_manager_8cpp_source}{Real\+Sense\+D435\+Manager.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00040                                                                                                                                                                                            \{}
\DoxyCodeLine{00041     rs2::colorizer colorMap;}
\DoxyCodeLine{00042     rs2::spatial\_filter spatialFilter;}
\DoxyCodeLine{00043     }
\DoxyCodeLine{00044     \textcolor{comment}{// Capture frames and apply post-\/processing}}
\DoxyCodeLine{00045     rs2::frameset streamData = pipelineStream.wait\_for\_frames(), alignedStreamData = \mbox{\hyperlink{class_real_sense_manager_acff6020a0a3efe31b637d6dc5b341dd7}{RealSenseManager::get\_align}}().process(streamData);}
\DoxyCodeLine{00046     depthFrame = alignedStreamData.get\_depth\_frame();}
\DoxyCodeLine{00047     spatialFilter.set\_option(RS2\_OPTION\_HOLES\_FILL, 1);}
\DoxyCodeLine{00048     depthFrame = spatialFilter.process(depthFrame);}
\DoxyCodeLine{00049     }
\DoxyCodeLine{00050     colorFrame = alignedStreamData.get\_color\_frame();}
\DoxyCodeLine{00051     colorizedDepthFrame = depthFrame.apply\_filter(colorMap);}
\DoxyCodeLine{00052     \mbox{\hyperlink{class_real_sense_manager_a024d711ab0bfee1d954f7bd3a83b197f}{RealSenseManager::setFrameID}}(\mbox{\hyperlink{class_real_sense_manager_aac01bf5b0fe977a03ff6ab9fa2bbf06f}{RealSenseD435Manager::getFrameID}}() + 1);}
\DoxyCodeLine{00053 \} \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} rs2::error \& e)\{}
\DoxyCodeLine{00054     std::cerr << \textcolor{stringliteral}{"{}RealSense error calling "{}} << e.get\_failed\_function() << \textcolor{stringliteral}{"{}("{}} << e.get\_failed\_args() << \textcolor{stringliteral}{"{}):\(\backslash\)n   "{}} << e.what() << std::endl;}
\DoxyCodeLine{00055     CV\_Error(\mbox{\hyperlink{constants_8hpp_ae4c7c146bcc762eadc9e87a62bd0924e}{RS\_CAMERA\_ERROR}}, \mbox{\hyperlink{constants_8hpp_a60f7f9c807b54759e94af5e875ab3e56}{RS\_CAMERA\_SCOPE}});}
\DoxyCodeLine{00056 \} \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception \& e) \{}
\DoxyCodeLine{00057     std::cerr << e.what() << std::endl;}
...
Definition at line \mbox{\hyperlink{_real_sense_d435_manager_8cpp_source_l00012}{12}} of file \mbox{\hyperlink{_real_sense_d435_manager_8cpp_source}{Real\+Sense\+D435\+Manager.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00012                                                                                                                                                                                                     \{}
\DoxyCodeLine{00013     rs2::log\_to\_console(RS2\_LOG\_SEVERITY\_ERROR);}
\DoxyCodeLine{00014     rs2::rates\_printer printer;}
\DoxyCodeLine{00015     rs2::config myConfiguration;}
\DoxyCodeLine{00016     myConfiguration.enable\_stream(rs2\_stream::RS2\_STREAM\_DEPTH, resX, resY, rs2\_format::RS2\_FORMAT\_Z16);}
\DoxyCodeLine{00017     myConfiguration.enable\_stream(rs2\_stream::RS2\_STREAM\_COLOR, resX, resY, rs2\_format::RS2\_FORMAT\_RGB8);}
\DoxyCodeLine{00018     rs2::pipeline\_profile myPipelineProfile = pipelineStream.start(myConfiguration);}
\DoxyCodeLine{00019     rs2::align align\_to(RS2\_STREAM\_COLOR);}
\DoxyCodeLine{00020     \mbox{\hyperlink{class_real_sense_manager_a66ccf804742763a2bf2d3b6d9342f191}{RealSenseManager::set\_align}}(rs2::align(align\_to));}
\DoxyCodeLine{00021     rs2::depth\_sensor sensor = myPipelineProfile.get\_device().first<rs2::depth\_sensor>();}
\DoxyCodeLine{00022     * scale = sensor.get\_depth\_scale();}
\DoxyCodeLine{00023     }
\DoxyCodeLine{00024     \textcolor{comment}{// Capture 30 frames to give autoexposure, etc. a chance to settle}}
\DoxyCodeLine{00025     \textcolor{keywordflow}{if} (firstBoot) \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 30; i++) pipelineStream.wait\_for\_frames();}
\DoxyCodeLine{00026     }
\DoxyCodeLine{00027     \mbox{\hyperlink{class_real_sense_manager_a1fef8da6adb415bc157d5ca2931fda7e}{RealSenseManager::set\_depth\_intrin}}(myPipelineProfile.get\_stream(RS2\_STREAM\_DEPTH).as<rs2::video\_stream\_profile>().get\_intrinsics());}
\DoxyCodeLine{00028     \mbox{\hyperlink{class_real_sense_manager_ab876bfaffd8a23924ff182573e900cda}{color\_intrin}} = myPipelineProfile.get\_stream(RS2\_STREAM\_COLOR).as<rs2::video\_stream\_profile>().get\_intrinsics();}
\DoxyCodeLine{00029     \mbox{\hyperlink{class_real_sense_manager_a1fcc8be70e92a51f9dcc82fdfe1b795e}{RealSenseManager::set\_color\_intrin}}(\mbox{\hyperlink{class_real_sense_manager_ab876bfaffd8a23924ff182573e900cda}{color\_intrin}});}
\DoxyCodeLine{00030     \mbox{\hyperlink{class_real_sense_manager_a821b3c038564cd28a4efd764e85e3656}{RealSenseManager::set\_color\_to\_depth}}(myPipelineProfile.get\_stream(RS2\_STREAM\_DEPTH).as<rs2::video\_stream\_profile>().get\_extrinsics\_to(myPipelineProfile.get\_stream(RS2\_STREAM\_COLOR)));}
\DoxyCodeLine{00031     \mbox{\hyperlink{class_real_sense_manager_a0e6df6bd8c81bd32022c18d06a272307}{RealSenseManager::set\_depth\_to\_color}}(myPipelineProfile.get\_stream(RS2\_STREAM\_COLOR).as<rs2::video\_stream\_profile>().get\_extrinsics\_to(myPipelineProfile.get\_stream(RS2\_STREAM\_DEPTH)));}
\DoxyCodeLine{00032 \} \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} rs2::error \& e)\{}
\DoxyCodeLine{00033     std::cerr << \textcolor{stringliteral}{"{}RealSense error calling "{}} << e.get\_failed\_function() << \textcolor{stringliteral}{"{}("{}} << e.get\_failed\_args() << \textcolor{stringliteral}{"{}):\(\backslash\)n   "{}} << e.what() << std::endl;}
\DoxyCodeLine{00034     CV\_Error(\mbox{\hyperlink{constants_8hpp_ae4c7c146bcc762eadc9e87a62bd0924e}{RS\_CAMERA\_ERROR}}, \mbox{\hyperlink{constants_8hpp_a60f7f9c807b54759e94af5e875ab3e56}{RS\_CAMERA\_SCOPE}});}
\DoxyCodeLine{00035 \} \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception \& e) \{}
\DoxyCodeLine{00036     std::cerr << e.what() << std::endl;}
